...
export default function Estoque({ toast, api }) {
  ...
  useEffect(() => { load(); loadCats(); }, [search, categoria]);
  ...
  return (
    <div className="space-y-4">
      ...
      {loading ? (
        <div className="flex items-center justify-center py-12"><RefreshCw size={24} className="animate-spin" style={{ color: C.muted }} /></div>
      ) : (
