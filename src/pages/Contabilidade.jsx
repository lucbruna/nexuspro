...
export default function Contabilidade({ toast, api }) {
  ...
  const imprimirDANFE = nf => {
    ...
    const addBox = (x, y, w, h, title, value, size = 9) => {
      ...
      doc.setTextColor(...gray); doc.setFont("helvetica", "bold"); doc.setFontSize(6.5);
      doc.text(title, x + 2, y + 4);
      doc.setTextColor(...dark); doc.setFont("helvetica", "normal"); doc.setFontSize(size);
    ...
    doc.setDrawColor(...line); doc.rect(10, 10, 190, 24);
    doc.setFont("helvetica", "bold"); doc.setTextColor(...dark); doc.setFontSize(15);
    ...
    doc.setFont("helvetica", "bold"); doc.setTextColor(...dark); doc.setFontSize(8);
    ...
    doc.setDrawColor(...line); doc.rect(10, 118, 190, 46);
    ...
    doc.setDrawColor(...green); doc.setTextColor(...green); doc.setFont("helvetica", "bold"); doc.setFontSize(11);
